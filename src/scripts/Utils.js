...
(function( name, factory ) {
    ...
    var hasTransform = (function()
    {
        ...
        for( var i = 0, t = props.length; i < t; ++i )
        {
    ...
    return {
        ...
        {
            var output = (current - capMin) / (capMax - capMin) * (outMax - outMin) + outMin;
        ...
        {
            var tagname = ( typeof tag === "string" ) ? tag : "div",
